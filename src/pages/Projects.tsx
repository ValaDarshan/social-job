  ...
  return (
    <div className="min-h-screen bg-[#0F172A] flex flex-col">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-80 border-r border-slate-800 bg-[#1E293B] flex flex-col hidden md:flex">
          <div className="p-6 border-b border-slate-800">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                className="block w-full pl-10 pr-3 py-2 border border-slate-700 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-slate-800/50 text-white placeholder-slate-400"
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className={`font-semibold text-sm ${project.id === 1 ? 'text-white' : 'text-slate-300'}`}>
                      {project.name}
                    </h3>
                  </div>
          ...
          <div className="max-w-5xl mx-auto p-6 lg:p-10">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-10">
              <div>
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h1 className="text-3xl font-bold text-white">Fintech Dashboard Redesign</h1>
                </div>
                <p className="text-slate-400 text-lg">GlobalBank Inc. • Due Nov 15, 2024</p>
              </div>
              
              <div className="flex gap-4">
                <div className="flex -space-x-3">
                  {teamMembers.map((member, i) => (
                    <img key={i} src={member.avatar} alt={member.name} className="w-10 h-10 rounded-full border-2 border-[#0F172A]" title={member.name} />
                  ))}
                  <button className="w-10 h-10 rounded-full border-2 border-[#0F172A] bg-slate-800 flex items-center justify-center text-slate-300 hover:bg-slate-700 transition-colors">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
              <div className="bg-[#1E293B] p-6 rounded-2xl border border-slate-800">
                ...
                <div className="text-3xl font-bold text-white">124h <span className="text-lg text-slate-500 font-normal">/ 200h</span></div>
              </div>
              <div className="bg-[#1E293B] p-6 rounded-2xl border border-slate-800">
                <div className="flex items-center gap-3 text-slate-400 mb-2">
                ...
                <div className="text-3xl font-bold text-white">24 <span className="text-lg text-slate-500 font-normal">/ 36</span></div>
              </div>
              <div className="bg-[#1E293B] p-6 rounded-2xl border border-slate-800">
                <div className="flex items-center gap-3 text-slate-400 mb-2">
                      ...
                      <div key={task.id} className="p-5 flex items-center justify-between hover:bg-slate-800/50 transition-colors">
                        <div className="flex items-center gap-4">
                          <button className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-colors ${
                            task.status === 'Completed' ? 'bg-green-500 border-green-500 text-white' : 'border-slate-600 hover:border-blue-500'
                          }`}>
                ...
                <div className="bg-[#1E293B] rounded-2xl border border-slate-800 p-6">
                  <div className="space-y-6 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-700 before:to-transparent">
                    ...
                    <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                      <div className="flex items-center justify-center w-10 h-10 rounded-full border border-slate-800 bg-slate-800 text-slate-500 shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 shadow z-10">
                      ...
                      <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 rounded-xl border border-slate-800 bg-slate-800/50 shadow">
                        <div className="flex items-center justify-between mb-1">
                          <div className="font-bold text-slate-200 text-sm">Sarah Jenkins</div>
                          <time className="text-xs font-medium text-slate-500">2h ago</time>
                        </div>
                        <div className="text-slate-400 text-sm">Uploaded new wireframes for the dashboard.</div>
                      </div>
                    </div>
                    ...
                    <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                      ...
                      <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 rounded-xl border border-slate-800 bg-slate-800/50 shadow">
                        <div className="flex items-center justify-between mb-1">
                          <div className="font-bold text-slate-200 text-sm">Elena Rodriguez</div>
                          <time className="text-xs font-medium text-slate-500">5h ago</time>
                        </div>
                        <div className="text-slate-400 text-sm">Approved the color palette.</div>
                      </div>
                    </div>
                    ...
                    <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                      ...
                      <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 rounded-xl border border-slate-800 bg-slate-800/50 shadow">
                        <div className="flex items-center justify-between mb-1">
                          <div className="font-bold text-slate-200 text-sm">David Chen</div>
                          <time className="text-xs font-medium text-slate-500">1d ago</time>
                        </div>
                        <div className="text-slate-400 text-sm">Commented on the typography choices.</div>
                      </div>
                    </div>
